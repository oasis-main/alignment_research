...
Hyperdimensional Computing (HDC) represents entities and relations as
high-dimensional bipolar vectors. We use non-commutative binding (fixed
random shifts per relation) so that directed edges are distinguishable
from their reverses, following standard practice. Embedding dimension is
4096 throughout.
